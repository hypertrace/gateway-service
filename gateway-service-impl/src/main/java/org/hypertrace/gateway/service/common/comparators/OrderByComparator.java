 ...
 * Column. The extensions of this class implement:
 *
 * <ul>
 *   <li>1. compareFunctionExpressionValues(T o1, T o2, String alias) which compares two objects
 *       given an alias of the function. It is expected that T has a way to determine the order
 *       given the alias and that this function will execute on a value that is a result of some
 *       aggregation.
 *   <li>2. compareColummnExpressionValues(T o1, T o2, String columnName) which compares two objects
 *       based on simple column names. This is expected to be applied to a simple column read.
 * </ul>
 *
