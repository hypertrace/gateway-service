        ...
        EntitiesRequest.newBuilder()
            .addSelection(
                buildAggregateExpression(
                    ...
                    "col1_alias",
                    List.of(getLiteralExpression(50))))
            .addOrderBy(
                buildOrderByExpression(
                    SortOrder.DESC,
                    buildAggregateExpression(
                        "col1", FunctionType.PERCENTILE, "col1_alias", List.of())))
            .build();
            ...
            .addOrderBy(
                buildOrderByExpression(
                    ...
                    buildAggregateExpression(
                        ...
                        FunctionType.PERCENTILE,
                        "col1_alias",
                        List.of(getLiteralExpression(78)))))
            .build();
    EntitiesRequest newRequest = OrderByPercentileSizeSetter.setPercentileSize(entitiesRequest);
        ...
        EntitiesRequest.newBuilder()
            .addSelection(
                buildAggregateExpression(
                    ...
                    FunctionType.PERCENTILE,
                    "col1_alias",
                    List.of(getLiteralExpression(85))))
            .addSelection(
                buildAggregateExpression(
                    "col2",
                    FunctionType.PERCENTILE,
                    "col2_alias",
                    List.of(getLiteralExpression(87))))
            .addOrderBy(
                buildOrderByExpression(
                    SortOrder.DESC,
                    buildAggregateExpression(
            ...
            .addOrderBy(
                buildOrderByExpression(
                    ...
                    buildAggregateExpression(
                        ...
                        FunctionType.PERCENTILE,
                        "col2_alias",
                        List.of(getLiteralExpression(95)))))
            .addOrderBy(
                buildOrderByExpression(
                    SortOrder.DESC,
                    buildAggregateExpression(
                        "col3", FunctionType.PERCENTILE, "col3_alias", List.of())))
            .build();
    EntitiesRequest newRequest = OrderByPercentileSizeSetter.setPercentileSize(entitiesRequest);
  ...
  public void testOrderByPercentileMissingSizeNoSelection_setSizeToDefault() {
    EntitiesRequest entitiesRequest =
        EntitiesRequest.newBuilder()
            .addSelection(
                buildAggregateExpression(
                    "col1", FunctionType.AVG, "col1_alias", List.of(getLiteralExpression(85))))
            .addOrderBy(
                buildOrderByExpression(
                    SortOrder.DESC,
                    buildAggregateExpression(
            ...
            .addOrderBy(
                buildOrderByExpression(
                    ...
                    buildAggregateExpression(
                        ...
                        FunctionType.PERCENTILE,
                        "col1_alias",
                        List.of(getLiteralExpression(99)))))
            .addOrderBy(
                buildOrderByExpression(
                    SortOrder.ASC,
                    buildAggregateExpression(
        ...
        EntitiesRequest.newBuilder()
            ...
            .addOrderBy(
                buildOrderByExpression(
                    SortOrder.DESC,
                    buildAggregateExpression(
                        "col2", FunctionType.AVG, "col2_alias", List.of(getLiteralExpression(95)))))
            .build();
    EntitiesRequest newRequest = OrderByPercentileSizeSetter.setPercentileSize(entitiesRequest);
