...
dependencies {
  ...
  implementation("org.hypertrace.entity.service:entity-service-client:0.6.0-SNAPSHOT")
  implementation("org.hypertrace.entity.service:entity-service-api:0.6.0-SNAPSHOT")
